...
const adminLogoCss = `.desktop-brand img{width:44px;height:44px;object-fit:contain;display:block;flex:0 0 44px}.desktop-brand{display:flex;align-items:center;gap:10px}.desktop-brand div{display:flex;flex-direction:column}.desktop-brand small{font-size:8px;letter-spacing:1.4px}`
