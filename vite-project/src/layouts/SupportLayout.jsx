...
import { BarChart3, Package, Boxes, Headphones } from 'lucide-react'

export function SupportLayout() {
  const links = [['dashboard','Dashboard',BarChart3],['orders','Orders',Package],['products','Products',Boxes],['issues','Customer Issues',Headphones]]
